...
const GENERATED_NOTE = `Generated by grammar/build-grammars.ts from microsoft/vscode-css#47@${CSS_GRAMMAR_COMMIT}; run \`vp run grammars\` after editing the generator; do not edit this file.`;
